...
//        }
        ...
        client.get(String.format(Define.SLTV_URL, Utility.convertSimpleDate(fromDate),customer.getCustType(),customer.getLabelFlag(),member != null ? member.getCode():""), new JsonHttpResponseHandler() {
                @Override
