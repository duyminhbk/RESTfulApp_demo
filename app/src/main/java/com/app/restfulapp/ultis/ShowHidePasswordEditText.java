...
public class ShowHidePasswordEditText extends AppCompatEditText {
  ...
  public boolean onTouchEvent(MotionEvent event) {
    ...
    if (event.getAction() == MotionEvent.ACTION_UP && drawableEnd != null) {
      ...
      if ((leftToRight && (x >= (this.getRight() - bounds.width()-40))) ||
              (!leftToRight &&  (x <= (this.getLeft() + bounds.width()+40)))){
  ...
  public void setVisiblityIndicatorShow( int visiblityIndicatorShow) {
  ...
  public void setVisiblityIndicatorHide( int visiblityIndicatorHide) {
