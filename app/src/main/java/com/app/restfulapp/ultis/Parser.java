...
//            index.put("P1");
//            index.put("P2");
//            index.put("Product No");
//            index.put("Packing");
//            index.put("Grand Total");
//            JSONArray headers = json.optJSONArray("Customers");
//            for(int i =0;i<headers.length();i++){
//                index.put(headers.getString(i));
//            }
//            result.put("index",index);
//            // process data
//            JSONObject data = new JSONObject();
//            JSONArray p1list = json.optJSONArray("P1List");
//            for(int i =0 ;i<p1list.length();i++){
//                JSONObject p1 = p1list.getJSONObject(i);
//
//            }
//            String p1Total = list.optString("Total");
//            JSONArray arr = list.optJSONArray("P2List");
