...
public class SLKHLayout extends RelativeLayout {
...
//	String headers[];
	...
	public SLKHLayout(Context context, AttributeSet attrs, int defStyleAttr) {
		this(context);
	}

	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
	public SLKHLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
		this(context);
	}
